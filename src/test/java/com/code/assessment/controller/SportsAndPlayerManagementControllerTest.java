...
import com.code.assessment.controller.SportsAndPlayerManagementController;
import com.code.assessment.controller.request.PlayerRequest;
import com.code.assessment.controller.request.SportRequest;
import com.code.assessment.controller.request.UpdatePlayerRequest;
import com.code.assessment.controller.response.PlayerResponse;
import com.code.assessment.controller.validator.SportsAndPlayerManagementValidator;
import com.code.assessment.exception.ConnectivityException;
import com.code.assessment.exception.DuplicateSportException;
import com.code.assessment.exception.SportNotAvaliableException;
import com.code.assessment.service.SportsAndPlayerService;
...
public class SportsAndPlayerManagementControllerTest {
	...
	@Mock
	private SportsAndPlayerManagementValidator codeRequestValidator;
	

	@Before
	public void setUp() throws Exception {
		doNothing().when(codeRequestValidator).validateplayerRequest(Mockito.any());
	}
	...
	//********   updatePlayerSports Started ****************/
		...
		public void updatePlayer_HappyPathResponse() {
			doNothing().when(codeRequestValidator).validateUpdatePlayerRequest(Mockito.any());
			when(sportsAndPlayerService.getPlayersWithNoSports()).thenReturn(buildListPlayerResponse(false));
	...
	//********   deleteSports Started ****************/
		...
		public void deleteSports_HappyPathResponse() {
			doNothing().when(codeRequestValidator).validateSportsRequest(Mockito.any());
