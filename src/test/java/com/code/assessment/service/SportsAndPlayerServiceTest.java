...
import com.code.assessment.convertor.PlayerResponseConverter;
import com.code.assessment.entity.Player;
import com.code.assessment.entity.Sport;
import com.code.assessment.exception.PlayerNotAvaliableException;
import com.code.assessment.exception.SportNotAvaliableException;
import com.code.assessment.repository.PlayerRepository;
import com.code.assessment.repository.RelationsRepository;
import com.code.assessment.repository.SportRepository;
...
public class SportsAndPlayerServiceTest {
	...
	public void getSportswithAssociatedPlayers_HappyPath() {
		...
		List<PlayerResponse> response =  sportsAndPlayerService.getSportswithAssociatedPlayers(Collections.singletonList("sirisha@test.com"));
