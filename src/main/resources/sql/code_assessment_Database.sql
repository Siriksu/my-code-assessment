...
CREATE USER 'myAssessmentUser'@'localhost' IDENTIFIED BY '@ssessment';
...
GRANT ALL PRIVILEGES ON sport_management.* TO 'myAssessmentUser'@'localhost';
...
--insert into players;
insert into players (email, level, age, gender) values ('sirisha@test.com', 9, 25, 'male');
...
insert into players (email, level, age, gender) values ('sirisha@test.com', 12, 25, 'male');

--gender should only accept 'Female','Male'

insert into players (email, level, age, gender) values ('sirisha@test.com', 9, 25, 'notmale');
...
insert into Relations (sport_Id, player_Id) values ((select id from sports where name = 'tennis'), (select id from players where email = 'sirisha@test.com'));
...
insert into Relations (sport_Id, player_Id) values ((select id from sports where name = 'cricket'), (select id from players where email = 'sirisha@test.com'));
insert into Relations (sport_Id, player_Id) values ((select id from sports where name = 'Golf'), (select id from players where email = 'sirisha@test.com'));
